            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="<?= base_url('/#services') ?>">Services</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="<?= base_url('/#partners') ?>">Our Partners</a></li>
    ...
    <div class="list">
        <?php foreach ($movies as $row) : ?>
            <div class="movie-item">
                <img class="" src="<?= base_url('assets/img/' . $row['cover_img']) ?>" alt="<?= $row['title'] ?>">
                <div class="mov-det">
                <button type="button" class="btn btn-primary" onclick="reserveSeat(<?= $row['id'] ?>)">Reserve Seat</button>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
...
<script>
    function reserveSeat(movieId) {
        window.location.href = '<?= base_url('/reserve/') ?>' + movieId;
    }
</script>
    </body>
</html>
